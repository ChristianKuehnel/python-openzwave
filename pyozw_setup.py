...
class Template(object):
    ...
    def get_openzwave(self, url='https://codeload.github.com/ChristianKuehnel/open-zwave/zip/master'):
        #Get openzwave
...
class OzwdevTemplate(GitTemplate):
    ...
    def get_openzwave(self, url='https://codeload.github.com/ChristianKuehnel/open-zwave/zip/Dev'):
        return Template.get_openzwave(self, url)
...
class EmbedTemplate(Template):
    ...
    def get_openzwave(self, url='https://raw.githubusercontent.com/ChristianKuehnel/python-openzwave/master/archives/open-zwave-master-{0}.zip'.format(pyozw_version)):
